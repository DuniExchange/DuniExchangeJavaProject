...
public class SearchProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Post_Account> listPost_AccountBySearch = new ArrayList<>();
              listPost_AccountBySearch = PAD.getListPost_AccountBySearch(txt);
        ...
        int numberItemSearch = PAD.getNumberOfAllProductBySearch(txt);
        
        request.setAttribute("listPost_Account", listPost_AccountBySearch);
        
        request.setAttribute("listC", listCategory);
        
        request.setAttribute("numberItem", numberItemSearch);

 ...
 * @author truon
 */
public class ChangeAdminState extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            dao.changeAccountAdmin(id, state);
            request.getRequestDispatcher("displayAccountManager").forward(request, response);

...
<div class="container-lg">
        ...
        <div class="table-wrapper" style="word-wrap: break-word;  text-align: center;">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-3"><h2>Manager <b style="color: #fd5631">Account</b></h2></div>
                </div>
            </div>
                ...
                <c:forEach items="${listAccount}" var="o">
                    <tr>
                        ...
                        <td class="Boqua"><img class="rounded-circle" width="48px" height="48px" alt=""
                            src="${o.userAvatarURL}" alt="${o.userUsername}"> </td>
                        <td class="Boqua">                  
                        <label class="custom-control ios-switch">
                            <input type="checkbox" class="ios-switch-control-input"  <c:if test="${o.isAdmin==true}"> checked=""</c:if> onclick="location.href = 'changeAdminState?aID=${o.userID}&state=${o.isAdmin}'">

<%-- 
    ...
    Created on : Oct 28, 2021, 8:18:00 PM
    Author     : truon
--%>
...
<div class="container-lg">
        ...
        <div class="table-wrapper" style="word-wrap: break-word;  text-align: center;">
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-3"><h2>Manager <b style="color: #fd5631">Category</b></h2></div>
                    <div class="col-sm-9">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr style="word-wrap: initial; text-align: center;">
                        ...
                        <th style="width: 25%;">Icon - code</th>
                ...
                <c:forEach items="${listC}" var="o">
                    <tr>
                        <td class="Boqua">${o.categoryID}</td>
                        <td>${o.categoryName}</td>
                        <td>${o.categoryIcon}</td>
                        <td class="Boqua">                
                            <i class="${o.categoryIcon}"></i>
                        </td>
                        <td class="Boqua">                  
